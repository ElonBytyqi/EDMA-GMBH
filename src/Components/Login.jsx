  ...
  const send = async (e) => {
    ...
    try {
      ...
      if (res.data?.error) {
        ...
        const userInfo = jwtDecode(res.data.jwtToken);
                ...
                <div className="md:mx-6 md:p-12">
                  ...
                  <form onSubmit={send}>
                    ...
                    <div className="mb-12 pb-1 pt-1 text-center">
                      ...
                      <button
                        className="mb-3 inline-block w-full rounded px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-dark-3  duration-150 ease-in-out hover:shadow-dark-2 focus:shadow-dark-2 focus:outline-none focus:ring-0 active:shadow-dark-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong transform transition-transform hover:-translate-y-1 active:translate-y-0"
                        type="submit"
