  ...
  return (
        ...
        <div className='  flex  justify-center  max-w-[1250px] m-auto min-h-[650px] pt-[10pc] '>
           <div className='w-[50%] heim'>
            ...
            <p className=' w-[85%] font-normal  mb-8  text-[23px] md:text-[30px]'>EDMA ist ein Beratungs- und Bauingenieurunternehmen, das auf die Planung, Überwachung und den Bau öffentlicher und privater Projekte spezialisiert ist.</p>
            <p className='md:text-lg text-[15px] tracking-wider leading-6 mb-24 bd:pb-0    md:leading-7 font-apple'> Es wurde im Jahr 2010 von einem Team
        ...
        <div className='edma w-50% pl-12 '>
            ...
            <span className='top-[440px] right-[210px]   absolute inline-block w-[230px] h-[230px] border-t-transparent border-l-transparent border-2 '></span>
            <span className='top-[240px] right-[408px]   absolute inline-block w-[230px] h-[230px] border-r-transparent border-b-transparent border-2 '></span>
           <div className=''>

                       <p  className='top-[270px] right-[288px] flex
             items-start  absolute  w-[230px] h-[230px] text-white text-center font-medium text-[210px] font-apple '> 15  </p>


<p  className='top-[580px] right-[338px] flex
